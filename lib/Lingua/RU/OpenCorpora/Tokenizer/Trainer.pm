package Lingua::RU::OpenCorpora::Tokenizer::Trainer;
...
Lingua::RU::OpenCorpora::Tokenizer::Trainer - create vectors from corpus
...
=head1 SYNOPSIS
    ...
    my $trainer = Lingua::RU::OpenCorpora::Tokenizer::Trainer->new({
        hyphens    => $hyphens,
        prefixes   => $prefixes,
